...
const VoiceCount = () => {
  ...
  useEffect(() => {
    ...
    recognitionObj.onresult = (event: any) => {
      console.log("");
      console.log("onresult", event.results, Object.keys(event.results));
      const results = Object.keys(event.results).map((key) => {
        ...
        if (
          ...
          console.log("trans", event.results[key][0].transcript);
